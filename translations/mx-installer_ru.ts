...
Диск с разделом, который Вы выбрали для установки, не годится.
    ...
    <message>
        ...
        <translation>Мы настоятельно рекомендуем Вам отменить операцию.
</translation>
    </message>
    <message>
        ...
        <translation>Если Вы не уверены, пожалуйста, выйдите из программы установки и запустите GSmartControl для получения дополнительной информации.
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вывод утилиты Smartmon:
</translation>
    </message>
    <message>
        ...
        <translation>Диск с разделом, который Вы выбрали для установки, проходит тест SMART (smartctl)
</translation>
    </message>
    <message>
        ...
        <translation>Однако, тесты показали, что накопитель будет иметь интенсивность отказов в течение года выше средней.
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Все готово для установки файловой системы MX Linux</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="491"/>
        <source>OK to format and use the entire disk (%1) for MX Linux?</source>
        <translation>ОК для форматирования и использования всего диска  (%1) для MX Linux?</translation>
    </message>
    <message>
...
%1 для раздела подкачки?</translation>
    ...
    <message>
        ...
        <translation>Форматирование раздела /home</translation>
    </message>
    <message>
        <location filename="../minstall.cpp" line="902"/>
        <source>Mounting the / (root) partition</source>
        <translation>Монтирование / (корневого) разделa</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К сожалению, установка GRUB не удалaсь. Это может быть из-за изменений в форматировании диска. Вы можете снять отметку установки GRUB и завершить установку MX Linux, затем перезагрузить с компакт-диска и использовать установку с функцией переустановки GRUB.</translation>
    </message>
    <message>
...
Do you want to reboot now?</source>
        <translation>Установка и настройка MX Linux завершена.
...
Вы действительно хотите остановить процесс сейчас?</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Oграничения&lt;/b&gt;&lt;br/&gt;Помните, что это программное обеспечение предоставляется абсолютно без гарантии. Создание резервныx копий Ваших данных перед началом работы является исключительно Вашей обязанностью.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Выберите разделы&lt;/b&gt;&lt;br/&gt;MX Linux требует корневого раздела. Раздел подкачки не является обязательным, но очень рекомендуется. Если Вы хотите использовать функцию Suspend-To-Disk МХ Linux, Вам понадобится раздел подкачки, который больше вашей физической памяти.&lt;/p&gt;&lt;p&gt;Если Вы выбираете отдельный раздел /home, то Вам будет легче обновить систему в будущем, и это будет невозможно, если Вы обновляете такую установку, которaя не имела отдельного домашнего раздела.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Обновление&lt;/b&gt;&lt;br/&gt;Чтобы обновить существующую установку Linux, выберите тот же домашний раздел, как и ранее, чтобы сохранить данные в /home.&lt;/p&gt;&lt;p&gt;Если Вы сохраняете существующий каталог /home, который находится на корневом разделе, программа установки не будет переформатировать корневой раздел. В результате, установка займет гораздо больше времени, чем обычно.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Предпочтительная файловая система&lt;/b&gt;&lt;br/&gt;Для MX Linux, Вы можете выбрать форматирование разделов с файловой системой ext2, ext3, ext4, jfs, xfs, btrfs или reiser. &lt;/p&gt;&lt;p&gt;&lt;b&gt;Bad Blocks&lt;/b&gt;&lt;br/&gt;Если Вы выбираете ext2, ext3 или ext4 в качестве типа форматирования, у Вас есть возможность проверки и исправления &quot;битых блоков&quot; на диске. Проверка &quot;битых блоков&quot; занимает очень много времени, так что Вы можете пропустить этот шаг, если Вы не подозреваете, что Ваш привод их имеет.&lt;/p&gt;</translation>
    </message>
    <message>
...
Возврат к шагу 1.</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Общие службы для Включения&lt;/b&gt;&lt;br/&gt;Выберите любые из этих общих служб, которые могут Вам понадобиться в конфигурации Вашей системы, и службы будут запускаться автоматически при запуске MX Linux.&lt;/p&gt;</translation>
    </message>
    <message>
...
Возврат к шагу 1.</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Поддержка MX Linux&lt;/b&gt;&lt;br/&gt;MX Linux поддерживается такими же людьми, как Вы. Некоторые помогают другим на форуме поддержки - https://forum.mxlinux.org, или переводят файлы справки на различные языки, или внoсят предложения, пишут документацию, или помогают в тестировании нового программного обеспечения.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Имейте Вашу копию MX Linux обновленной&lt;/b&gt;&lt;br/&gt;Для получения дополнительной информации и обновлений MX Linux, пожалуйста, посетите https://mxlinux.org&lt;/p&gt;</translation>
    </message>
    <message>
...
Enjoy using MX Linux.</source>
        <translation>MX Linux является независимым дистрибутивом на основе Debian Stable

MX Linux использует некоторые компоненты из MEPIS Linux, которые выпущены под свободной лицензией Apache. Некоторые компоненты MEPIS были модифицированы для MX Linux.

Получайте удовольствие от использования MX Linux.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Оставьте свободное пространство до:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматическая установка с использованием всего диска</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сохранить данные в /home (при обновлении)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>/home раздел:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Установить GRUB для MX Linux и Windows</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Установка MX Linux</translation>
    </message>
    <message>
...
Do you want to continue the installation?</source>
        <translation type="vanished">Вы используете 32-битную ОС, запущенную в режиме UEFI, система не сможет загрузиться, если Вы не выберете Legacy Boot или аналогичную при перезагрузке.
